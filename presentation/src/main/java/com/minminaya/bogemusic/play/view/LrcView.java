package com.minminaya.bogemusic.play.view;
...
import com.minminaya.bogemusic.play.view.inter.ILrcView;
...
public class LrcView extends View implements ILrcView {
    ...
    private static final int SIZE_FOR_TIME_DEFAULT = 30;
    /**
     * 时间文字大小
     **/
    private int mCurentTimeSize = SIZE_FOR_TIME_DEFAULT;
    /**
     * 是否画时间线
     **/
    ...
    public void init() {
        ...
        mPaintForTimeLine.setTextSize(mCurentTimeSize);
...
//        mCurentTimeSize = (int) (mCurentTimeSize * mCurScalingFactor);
